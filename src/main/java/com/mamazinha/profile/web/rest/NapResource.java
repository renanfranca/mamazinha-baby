...
import com.mamazinha.profile.service.NapService;
...
/**
 * REST controller for managing {@link com.mamazinha.profile.domain.Nap}.
 */
@RestController
@RequestMapping("/api")
public class NapResource {
    ...
    private static final String ENTITY_NAME = "profileNap";
    ...
    public List<NapDTO> getAllNaps() {
        log.debug("REST request to get all Naps");
        return napService.findAll();
    }
