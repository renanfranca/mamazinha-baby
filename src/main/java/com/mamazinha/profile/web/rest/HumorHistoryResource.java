...
import com.mamazinha.profile.service.HumorHistoryService;
...
/**
 * REST controller for managing {@link com.mamazinha.profile.domain.HumorHistory}.
 */
@RestController
@RequestMapping("/api")
public class HumorHistoryResource {
    ...
    private static final String ENTITY_NAME = "profileHumorHistory";
    ...
    public List<HumorHistoryDTO> getAllHumorHistories() {
        log.debug("REST request to get all HumorHistories");
        return humorHistoryService.findAll();
    }
