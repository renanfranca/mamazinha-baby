...
import com.mamazinha.profile.service.BreastFeedService;
...
/**
 * REST controller for managing {@link com.mamazinha.profile.domain.BreastFeed}.
 */
@RestController
@RequestMapping("/api")
public class BreastFeedResource {
    ...
    private static final String ENTITY_NAME = "profileBreastFeed";
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/breast-feeds/{id}", consumes = "application/merge-patch+json")
    ...
    public List<BreastFeedDTO> getAllBreastFeeds() {
        log.debug("REST request to get all BreastFeeds");
        return breastFeedService.findAll();
    }
