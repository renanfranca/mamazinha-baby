...
public class NapResource {
    ...
    public ResponseEntity<NapTodayDTO> getTodaySumNapsHoursByBabyProfile(@PathVariable Long id) {
        NapTodayDTO napTodayDTO = napService.getTodaySumNapsHoursByBabyProfile(id);
