...
import com.mamazinha.babyprofile.repository.HumorRepository;
import com.mamazinha.babyprofile.service.HumorService;
...
/**
 * REST controller for managing {@link com.mamazinha.babyprofile.domain.Humor}.
 */
@RestController
@RequestMapping("/api")
public class HumorResource {
    ...
    private static final String ENTITY_NAME = "babyHumor";
     ...
     */
    @GetMapping("/humors")
    public ResponseEntity<List<HumorDTO>> getAllHumors(Pageable pageable) {
