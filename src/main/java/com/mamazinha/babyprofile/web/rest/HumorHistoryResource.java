...
import com.mamazinha.babyprofile.service.HumorHistoryService;
import com.mamazinha.babyprofile.service.dto.HumorHistoryDTO;
import com.mamazinha.babyprofile.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.mamazinha.babyprofile.domain.HumorHistory}.
 */
@RestController
@RequestMapping("/api")
public class HumorHistoryResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/humor-histories/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<HumorHistoryDTO>> getAllHumorHistories(Pageable pageable) {
        log.debug("REST request to get a page of HumorHistories");
        Page<HumorHistoryDTO> page = humorHistoryService.findAll(pageable);
